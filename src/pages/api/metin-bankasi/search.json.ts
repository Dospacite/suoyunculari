...
export const GET: APIRoute = async ({ url }) => {
  ...
  try {
    ...
    const result = await searchConcordPlays({
      ...
      minCast: url.searchParams.get('minCast') ?? '',
      maxCast: url.searchParams.get('maxCast') ?? '',
      femaleRoles: url.searchParams.get('femaleRoles') ?? '',
      femaleRolesMax: url.searchParams.get('femaleRolesMax') ?? '',
      maleRoles: url.searchParams.get('maleRoles') ?? '',
      maleRolesMax: url.searchParams.get('maleRolesMax') ?? '',
      neutralRoles: url.searchParams.get('neutralRoles') ?? '',
      neutralRolesMax: url.searchParams.get('neutralRolesMax') ?? '',
